...
import com.djt.spark.factory.ModelFactory;
import com.djt.spark.service.StreamingUvService;
import com.djt.spark.common.PropertiesUtil;
import com.djt.spark.model.NginxLogModel;
import com.djt.spark.monitor.MonitorStopThread;
import com.djt.spark.service.StreamingPvService;
...
public class NginxLogStreaming
{
  public static Logger log = Logger.getLogger(NginxLogStreaming.class);
  ...
  public static Function0<JavaStreamingContext> createContext(final Properties serverProps) {
    ...
    Function0<JavaStreamingContext> createContextFunc = new Function0<JavaStreamingContext>()
    {
      ...
      public JavaStreamingContext call() throws Exception
      {
        ...
        Map<TopicAndPartition, Long> consumerOffsetsLong = NginxLogStreaming.getConsumerOffsets(kafkaCluster,groupId,topicSet);
